...
#'
#' @param timeVar String. The name of the variable in the model that corresponds to time.
...
#'
#' @examples
#' equation_to_fit <- tef_change_expo3('timeVar',rateForm = ~ xvar1*xvar2) # both variables should be numeric!
#' 
